...
DVRange FS malicious true, GGM false/fs_prove
                        time:   [1.9531 s 1.9654 s 1.9801 s]
Found 11 outliers among 100 measurements (11.00%)
  3 (3.00%) high mild
  8 (8.00%) high severe
Benchmarking DVRange FS malicious true, GGM false/fs_verify: Warming up for 3.0000 sprove1...

DVRange FS malicious true, GGM false/fs_verify
                        time:   [1.2900 s 1.3010 s 1.3146 s]
